...
// waveguide
AudioConnection patchCord19(adc1, 0, waveguide, 0);
AudioConnection patchCord20(waveguide, 0, mixer3, 2);

// dac
AudioConnection patchCord21(mixer3, pt8211_1);
